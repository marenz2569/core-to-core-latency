...
/// This class maps cache lines to a specific CHA box via the UNC_CHA_REQUESTS.READ_* counter.
...
public:
  ...
  [[nodiscard]] static auto run(void* Cachelines, std::size_t NumberOfCachelines) -> ChaToCachelinesMap;
};
